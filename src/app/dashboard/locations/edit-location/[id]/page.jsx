      ...
      <form className="" onSubmit={submitEditHandler}>
        <div className="flex flex-row justify-between w-full">
          ...
          <ImageUpload
            ...
            previewImageEdit={formLocation.image}
          />
        </div>
        ...
        {formLocation.latitude && formLocation.longitude ? (
          <Map
            onClick={getLocationCordsHandler}
            idZoomedToPosition={true}
            coordsToEdit={[
              parseFloat(formLocation.latitude),
              parseFloat(formLocation.longitude)
            ]}
          />
        ) : (
          'Cargando ubicación...'
